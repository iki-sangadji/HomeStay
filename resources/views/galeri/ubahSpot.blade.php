        ...
        <div class="container">
            <div class="row justify-content-center pb-4">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    <h2 class="mb-4 tekstengahbawah">Ubah Spot</h2>
                </div>
            </div>
        </div>
    </section>
						...
						<div class="col-md-6 d-flex align-self-stretch ftco-animate">
							<div class="media block-6 services d-block">
								...
								<div class="media-body">
									...
									<p>
                                        Perbarui spot wisata agar pengunjung dapat melakukan aktivitas trip.
									</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 d-flex align-self-stretch ftco-animate">
							<div class="media block-6 services d-block">
								...
								<div class="media-body">
									...
									<p>
                                        Perbarui spot Wisata yang dapat dimasukan ke agenda paket perjalanan.
									</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 d-flex align-self-stretch ftco-animate">
							<div class="media block-6 services d-block">
								...
								<div class="media-body">
									...
									<p>
                                        Perbarui spot wisata yang dapat dikenali oleh pemimpin perjalanan (tour guide).
									</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 d-flex align-self-stretch ftco-animate">
							<div class="media block-6 services d-block">
								...
								<div class="media-body">
									...
									<p>
                                        Perbarui spot wisata yang dapat dijadwalkan dan memberikan aktivitas menyenangkan bagi pengunjung.
									</p>
								</div>
							</div>
						</div>
				...
				<div class="col-md-6 pl-md-5 py-5">
					<div class="row justify-content-start pb-3">
						<div class="col-md-12 heading-section ftco-animate">
							<h2 class="mb-4 text-uppercase">Perbarui Spot</h2>
                            
                            <form method="POST" action="{{route("update_galeri",$galeri->id_galeri)}}" enctype="multipart/form-data" class="bg-light p-5 contact-form">
                            @csrf
