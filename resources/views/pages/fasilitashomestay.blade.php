    ...
    <section class="ftco-section">
		<div class="container">
			<div class="row d-flex justify-content-between mt-5 search-wrap-1 ftco-animate p-4">
				<div class="col-md-6">
					<p class="h1 text-uppercase text-white">Fasilitas Homestay</p>
				</div>
				<div class="col-md-6">
							...
							<tbody>
								...
								@foreach ($fasilitasList as $row)
										<tr>
											...
											<td>
												<form onsubmit="return confirm('Yakin Ingin Menghapus?');" action="{{route("delete_fasilitas_home_stay",$row->id_fasilitas)}}" method="get" >
													{{ csrf_field() }}
