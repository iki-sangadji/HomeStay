...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('mhomestay/img/core-img/favicon.png') }}">

    <!-- Stylesheet -->
    <link rel="stylesheet" href="{{ asset('mhomestay/style.css') }}">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- **** All JS Files ***** -->
    <!-- jQuery 2.2.4 -->
    <script src="{{ asset('mhomestay/js/jquery.min.js') }} "></script>
    <!-- Popper -->
    <script src="{{ asset('mhomestay/js/popper.min.js') }}"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('mhomestay/js/bootstrap.min.js') }}"></script>
    <!-- All Plugins -->
    <script src="{{ asset('mhomestay/js/roberto.bundle.js') }}"></script>
    <!-- Active -->
    <script src="{{ asset('mhomestay/js/default-assets/active.js') }}"></script>
